# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-29 14:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='INR', max_digits=10)),
                ('type', models.IntegerField(blank=True, choices=[(1, 'Income'), (-1, 'Expenditure')], default=1)),
                ('mode', models.CharField(choices=[('CA', 'Cash'), ('BT', 'Bank Transfer')], default='CA', max_length=50)),
